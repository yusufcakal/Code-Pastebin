...
<body>
	...
	<?php if ($data) { ?>
		...
		<div class="row">
			<div class="col-md-12">
				<pre style="margin-bottom: 20px;" class="line-numbers language-<?php echo $data['language']; ?>"><code   class="language-<?php echo $data['language']; ?>" ><?php echo $data['code']; ?></code></pre>
			</div>
		</div>
